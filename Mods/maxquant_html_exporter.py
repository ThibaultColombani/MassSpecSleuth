...
"""
maxquant_html_exporter.py - Orchestrator for the MaxQuant interactive HTML QC report.

Same tab architecture as diann_html_exporter and jmod_html_exporter; tabs that
require DIA-NN-specific data (fill_times, Precursor.Quantity, features) are
hidden automatically by their own is_visible() guards.
"""
...
def export_html_report(processor, output_path: str,
                       title: str = "MaxQuant QC Report") -> None:
    """
    Build and write the MaxQuant QC HTML report.

    Parameters
    ----------
    processor : MaxquantProcessor | CombinedProcessor
