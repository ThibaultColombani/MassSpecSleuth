...
"""
jmod_html_exporter.py - Orchestrator for the Jmod interactive HTML QC report.

Same tab architecture as diann_html_exporter; tabs that require DIA-NN-specific
columns (Retention time, Precursor.Quantity, features) are hidden automatically
by their own is_visible() guard.
"""
...
def export_html_report(processor, output_path: str,
                       title: str = "Jmod QC Report") -> None:
    """
    Build and write the Jmod QC HTML report.

    Parameters
    ----------
    processor : JmodProcessor | CombinedProcessor
